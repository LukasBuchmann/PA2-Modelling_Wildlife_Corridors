...
# Liste der Abkürzungen {.unnumbered .unlisted}
...
#| tbl-cap: "List of Top Critical Bottlenecks identified by the model. IDs correspond to the labels in Figure 3. Coordinates are in CH1903+ / LV95 (EPSG:2056)."
#| echo: false
#| output: asis
...
The bottlenecks identified in Table @tbl-bottlenecks represent acute conflict zones. The validation of Bottleneck 5 (Schneitenberg) confirms that the model correctly identifies locations requiring engineering solutions.
...
# List of illustrations {.unnumbered}
...
├── src/                                      # Source Code
│   ├── 01_resistance_surface_generation.py   # Rasterization module
│   ├── 02_local_lcp_analysis.py              # LCP Algorithm module
│   └── 03_extract_bottlenecks.py             # Visualization module
└── results/                                  # Output folder (Generated by script)
    ├── clustered_bottlenecks.csv             # Bottleneck csv data
    └── method_01_grid.png                    # Methods image
```
